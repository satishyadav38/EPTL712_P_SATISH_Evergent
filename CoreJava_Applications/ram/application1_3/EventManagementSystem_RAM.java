...
switch(module1.valueOf(module))          //1-open
{
...
case F:
	...
	switch(menucode.valueOf(module))         //3-open
	{
...
case P:
	...
	module=br.nextLine();
	switch(submodule2.valueOf(module))               //5-open
	{
...
System.out.println("Enter your Module code (I,S,M) : ");
	...
	module=br.nextLine();
switch(submodule3.valueOf(module))                  //6-open
{
